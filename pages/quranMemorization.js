            ...
            <div className={styles.MainContentArea}>
              ...
              <div className={styles.courseIntro}>
                ...
                <div className={styles.list}>
                  ...
                  <p>
                    This course aims to develop students' memorization skills, enhance their understanding of the Quranic verses, and cultivate a deep spiritual connection with the Quran through regular recitation and revision.
                  </p>
                </div>
              </div>
